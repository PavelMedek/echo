...
const SYSTEM_PROMPT = {
  image:
    "You turn image into text. If is is a photo of a document, transcribe it. If is it not a document, describe it",
...
export async function extractTextContent(
  ...
  assert(url, "Failed to get URL for storageId");
      ...
      messages: [
        {
          ...
          content: [
            ...
            {
              type: "text",
              text: "Extract the text content and convert it to markdown without explaining you'll do so.",
            },
          ],
        },
      ],
