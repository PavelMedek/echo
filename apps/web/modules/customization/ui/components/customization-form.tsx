              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="Welcome message showns wher chat oper"
                      rows={3}
                    />
                  </FormControl>
                  <FormDescription>
                    The first messasge users will see when they open the chat
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mb-4 text-muted-foreground text-sm">
                  Quick reply suggestions shows to customer to help guide
                  conversation.
                </p>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            {...field}
                            placeholder="E.g., What are you pricing plans?"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            {...field}
                            placeholder="E.g., I need heplp with my account"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
