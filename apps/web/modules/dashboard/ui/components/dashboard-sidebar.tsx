...
const customerSupportItems = [
  ...
  { title: "Klowledge Base", url: "/files", icon: LibraryBigIcon },
];
...
const accountItems = [
  { title: "Plan & Billing", url: "/billing", icon: CreditCardIcon },
];
            ...
            <UserButton
              ...
              appearance={{
                elements: {
                  rootBox: "w-full! h-8!",
                  userButtonTrigger:
                    "w-full! p-2! hover:bg-sidebar-accent! hover:text-sidebar-accent-foregroung! group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
                  userButtonBox:
